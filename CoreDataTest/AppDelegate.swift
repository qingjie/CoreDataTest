...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupAppearance(){
        ...
        navigationBarAppearance.titleTextAttributes = [NSForegroundColorAttributeName:UIColor.orangeColor()]
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.qingjiezhao.www.CoreDataTest" in the application's documents Application Support directory.
